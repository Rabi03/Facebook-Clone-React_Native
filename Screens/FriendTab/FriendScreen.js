...
export default function FriendScreen({ navigation }) {
  const onPressGroupSearchHandler = () => {
    navigation.navigate('GroupSearch');
  };
  const onPressGoToGroupHandler = (groupId) => {
      ...
      <ScrollView bounces={false}>
        <View style={styles.topWrapper}>
          <View style={styles.titleWrapper}>
            ...
            <TouchableOpacity
              onPress={onPressGroupSearchHandler}
          ...
          >
            ...
            <TouchableOpacity style={styles.navigatorItem}>
              <FontAwesome5Icon name='cc-discover' size={20}></FontAwesome5Icon>
          ...
          >
            {groups.map((group, index) => (
              <View key={index}>
                {(index < groups.length - 1 || index > 9) && (
                  <TouchableOpacity
                    onPress={onPressGoToGroupHandler.bind(this, group.id)}
            ...
            >
              ...
              <Image
                source={{
                  uri: groups[groups.length > 10 ? 10 : groups.length - 1]
                    .avatar_url,
                }}
                style={styles.groupAvatar}
              ></Image>
        ...
        <FriendPosts navigation={navigation} />
      </ScrollView>
    </View>
  );
}
