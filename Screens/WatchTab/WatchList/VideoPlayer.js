...
class VideoPlayer extends Component {
  ...
  onGestureEventHandler({ nativeEvent }) {
    ...
    let nextPositionMillis =
      this._startDraggingPosition +
      (translationX / maxTimeBarWidth) * this._maxPositionMillis;
    nextPositionMillis =
  ...
  async onPressTimeBarHandler({ nativeEvent }) {
    ...
    let nextPositionMillis =
      (locationX / maxTimeBarWidth) * this._maxPositionMillis;
    nextPositionMillis =
      nextPositionMillis < 0
        ? 0
        : nextPositionMillis > this._maxPositionMillis
  ...
  onPressToggleControllerHandler() {
    const { isAutoToggleController, onShowController, onHideController } =
      this.props;
  ...
  render() {
    ...
    if (isCenterVertical)
      videoWrapperOffsetTop = (SCREEN_HEIGHT - fixedVideoHeight) / 2;
      ...
      >
        ...
        >
          <Video
            ...
            onPlaybackStatusUpdate={this.onPlaybackStatusUpdateHandler.bind(
              this
            )}
          ...
          >
            ...
            >
              <View style={styles.btnControlWrapper}>
                ...
                >
                  <Animated.View
                    style={{ position: 'absolute', opacity: pauseBtnOpacity }}
                  >
                    <FontAwesome5Icon
                      name='pause-circle'
                      size={60}
                ...
                <View style={styles.timeBar}>
                  ...
                  >
                    <TouchableOpacity activeOpacity={1}>
                      <PanGestureHandler
                        onHandlerStateChange={this.onHandlerStateChangeHandler.bind(
                          this
                        )}
                      ...
                      >
                        <Animated.View
                          style={{
                            ...styles.btnTimeControl,
                            left: this._offsetXTimePoint,
                          }}
                        ></Animated.View>
                      </PanGestureHandler>
                    </TouchableOpacity>
        ...
        <PanGestureHandler
          onHandlerStateChange={this.onOptionsandlerStateChangeHandler.bind(
            this
          )}
