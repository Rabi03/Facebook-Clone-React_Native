...
import PostTool from '../HomeTab/PostTool/PostTool';
...
export default function ProfileX({ navigation, route }) {
  const user = data.users[route.params.userId];
  const friends = data.users[route.params.userId].friends;
  let isFriend = false;
