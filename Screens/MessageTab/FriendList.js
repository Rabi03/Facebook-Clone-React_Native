...
const friendList = [
  ...
  },
  {
    id: 4,
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeKZYYfBtlYAVrWfSk1xL-h2RYJ99059nA-A&usqp=CAU',
    name: 'Jeson',
  },
  {
    id: 5,
  ...
  {
    id: 9,
    image: 'https://cdn.pixabay.com/photo/2014/07/09/10/04/man-388104_1280.jpg',
    name: 'Sagor',
  },
];
  ...
  return (
    ...
    >
      <ScrollView horizontal>
        {friendList.map((f) => (
          <View key={f.id} style={{ margin: 5, alignItems: 'center' }}>
            <IconBadge
              MainElement={<Thumbnail source={{ uri: f.image }} />}
              BadgeElement={
                <Icon
                  name='primitive-dot'
