...
export default function MessageScreen({ navigation }) {
  return (
    <View>
      ...
      >
        <Text style={{ marginLeft: 5, fontSize: 25 }}>Messages</Text>
        <Button rounded style={{ backgroundColor: 'rgba(0,0,0,0.01)' }}>
      ...
      <ScrollView>
        <View style={{ paddingBottom: 55 }}>
          ...
          <List>
            <MessageListItem
              image='https://img.freepik.com/free-photo/handsome-young-businessman-shirt-eyeglasses_85574-6228.jpg?size=626&ext=jpg'
              active={false}
              time='2m'
              name='Kumar Pratik'
            ...
            />
            <MessageListItem
              image='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeKZYYfBtlYAVrWfSk1xL-h2RYJ99059nA-A&usqp=CAU'
              active={false}
              time='1h'
              name='Satin Badsin'
              navigation={navigation}
